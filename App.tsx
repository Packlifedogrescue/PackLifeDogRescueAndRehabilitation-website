...
export default function PackLifeWebsite() {
  ...
  const [openPhilosophy, setOpenPhilosophy] = useState<string | null>(null);
  const [page, setPage] = useState<"home" | "apply" | "founders" | "contact">("home");
  ...
  useEffect(() => {
    const score =
      (housing === "House" ? 2 : housing === "Apartment" ? 1 : 0) +
      (experience === "Experienced" ? 2 : experience === "Some" ? 1 : 0);
    ...
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          if (page === "home" && entry.isIntersecting) setActive((entry.target as HTMLElement).id);
        });
      },
      { threshold: 0.55 }
    );
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top,rgba(224,193,90,0.10),transparent_18%),linear-gradient(180deg,#122E4A_0%,#102944_45%,#0E2338_100%)] text-[#F4F8FC] selection:bg-[#D4AF37]/30">
            ...
            {navItems.map(([id, label]) => (
              <a
                ...
                className={`rounded-full px-4 py-2 text-sm font-medium transition-all duration-200 ${
                  (page === "home" && active === id) || (page === "contact" && id === "contact")
      ...
      <main id="top" className="relative">
        {page === "founders" ? (
          <section className="px-6 pb-22 pt-20 lg:px-8 lg:pt-24">
            <div className="mx-auto max-w-7xl">
              <div className="mx-auto max-w-3xl text-center">
                ...
                <div className="mt-8 flex justify-center gap-4">
                  <a href="#top" onClick={() => { setPage("home"); window.location.hash = ""; }} className="rounded-2xl bg-[#D4AF37] px-6 py-3 font-bold text-[#102944] transition duration-200 hover:-translate-y-0.5 hover:bg-[#E0C15A]">Back to Home</a>
                  <a href="#contact" onClick={() => setPage("contact")} className="rounded-2xl border border-[#3B6C99] px-6 py-3 font-medium text-white transition duration-200 hover:-translate-y-0.5 hover:bg-white/5 hover:text-[#E0C15A]">Contact Pack Life</a>
                </div>
              </div>

              <div className="mt-14 grid gap-6 md:grid-cols-3">
                {founderCards.map((person) => (
                  <div key={person.name} className="rounded-[1.9rem] border border-[#2E5B86]/80 bg-[linear-gradient(180deg,rgba(24,58,91,0.92)_0%,rgba(16,41,68,0.98)_100%)] p-8 shadow-[0_24px_48px_rgba(0,0,0,0.18)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_28px_56px_rgba(0,0,0,0.22)]">
          ...
          <section className="px-6 pb-22 pt-20 lg:px-8 lg:pt-24">
            <div className="mx-auto max-w-6xl">
              ...
              <div className="mt-14 grid gap-6 lg:grid-cols-2">
                <div className="rounded-[2rem] border border-[#2E5B86]/80 bg-[linear-gradient(180deg,rgba(24,58,91,0.92)_0%,rgba(16,41,68,0.98)_100%)] p-8 shadow-[0_24px_48px_rgba(0,0,0,0.18)]">
                  ...
                  <div className="mt-7 flex flex-wrap gap-4">
                    ...
                    <a href="#philosophy" onClick={() => setPage("home")} className="rounded-2xl border border-[#3B6C99] px-6 py-3 font-medium text-white transition duration-200 hover:-translate-y-0.5 hover:bg-white/5 hover:text-[#E0C15A]">Read Philosophy</a>
                  </div>
                </div>

                <div className="rounded-[2rem] border border-[#2E5B86]/80 bg-[linear-gradient(180deg,rgba(18,46,74,0.96)_0%,rgba(14,35,56,0.98)_100%)] p-8 shadow-[0_24px_48px_rgba(0,0,0,0.18)]">
                  ...
                  <div className="mt-7 flex flex-wrap gap-4">
                    ...
                    <a href="#contact" onClick={() => setPage("contact")} className="rounded-2xl border border-[#3B6C99] px-6 py-3 font-medium text-white transition duration-200 hover:-translate-y-0.5 hover:bg-white/5 hover:text-[#E0C15A]">Questions? Contact Us</a>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 grid gap-6 md:grid-cols-3">
                {[
                  ["Intentional Review", "Every application is reviewed with fit, structure, and long-term success in mind."],
                  ["No Rushed Placements", "We do not move dogs just to move them. We move them when the match makes sense."],
                  ["Clear Expectations", "Our process is built around honesty, leadership, and the environment each dog will need."],
                ].map(([title, text]) => (
                  <div key={title} className="rounded-[1.6rem] border border-[#2E5B86]/80 bg-[linear-gradient(180deg,rgba(18,46,74,0.96)_0%,rgba(14,35,56,0.98)_100%)] p-6 shadow-[0_18px_36px_rgba(0,0,0,0.14)]">
          ...
          <section className="px-6 pb-22 pt-20 lg:px-8 lg:pt-24">
            <div className="mx-auto max-w-5xl">
              <div className="text-center">
                ...
                <div className="mt-8 flex justify-center gap-4">
                  <a href="#top" onClick={() => { setPage("home"); window.location.hash = ""; }} className="rounded-2xl bg-[#D4AF37] px-6 py-3 font-bold text-[#102944] hover:bg-[#E0C15A]">Back to Home</a>
                </div>
              </div>
                ...
                <div className="rounded-[2rem] border border-[#2E5B86]/80 bg-[linear-gradient(180deg,rgba(18,46,74,0.96)_0%,rgba(14,35,56,0.98)_100%)] p-8 shadow-[0_24px_48px_rgba(0,0,0,0.18)]">
                  ...
                  {showContactThankYou ? (
                    <div className="mt-6 rounded-[1.6rem] border border-[#D4AF37]/20 bg-[linear-gradient(180deg,rgba(212,175,55,0.10)_0%,rgba(212,175,55,0.05)_100%)] p-6 shadow-[0_18px_34px_rgba(0,0,0,0.10)]">
                      ...
                      <p className="mt-4 text-[#DCE7F2] leading-8">Your message has been submitted to Pack Life Dog Rescue And Rehabilitation. We typically respond within 24–48 hours.</p>
                      <div className="mt-6 flex flex-wrap gap-4">
                        <button
                          ...
                          className="rounded-2xl bg-[#D4AF37] px-6 py-3 font-bold text-[#102944] transition duration-200 hover:-translate-y-0.5 hover:bg-[#E0C15A]"
                        >
                          Send Another Message
                        </button>
                        <a href="#top" onClick={() => { setPage("home"); window.location.hash = ""; }} className="rounded-2xl border border-[#3B6C99] px-6 py-3 font-medium text-white transition duration-200 hover:-translate-y-0.5 hover:bg-white/5 hover:text-[#E0C15A]">Back to Home</a>
                      </div>
                    </div>
                  ) : (
                    <form className="mt-6 space-y-4" onSubmit={handleContactSubmit}>
                      <div className="grid gap-4 sm:grid-cols-2">
                        <label className="block">
                          <span className="mb-2 block text-sm font-medium text-[#DCE7F2]">First Name</span>
                          <input type="text" name="First Name" placeholder="Your first name" required className="w-full rounded-2xl border border-[#2E5B86]/70 bg-white/[0.03] px-4 py-3 text-white outline-none transition focus:border-[#D4AF37]/40 focus:bg-white/[0.05]" />
                        </label>
                        <label className="block">
                          <span className="mb-2 block text-sm font-medium text-[#DCE7F2]">Last Name</span>
                          <input type="text" name="Last Name" placeholder="Your last name" required className="w-full rounded-2xl border border-[#2E5B86]/70 bg-white/[0.03] px-4 py-3 text-white outline-none transition focus:border-[#D4AF37]/40 focus:bg-white/[0.05]" />
                        </label>
                      </div>

                      <label className="block">
                        <span className="mb-2 block text-sm font-medium text-[#DCE7F2]">Email</span>
                        <input type="email" name="Email" placeholder="you@example.com" required className="w-full rounded-2xl border border-[#2E5B86]/70 bg-white/[0.03] px-4 py-3 text-white outline-none transition focus:border-[#D4AF37]/40 focus:bg-white/[0.05]" />
                      </label>
                      ...
                      {selectedInquiryType === "Adoption" && (
                        <>
                          <label className="block">
                            <span className="mb-2 block text-sm font-medium text-[#DCE7F2]">Housing Type</span>
                            <select value={housing} onChange={(e) => setHousing(e.target.value)} name="Housing" className="w-full rounded-2xl border border-[#2E5B86]/70 bg-white/[0.03] px-4 py-3 text-white">
                          ...
                          <label className="block">
                            <span className="mb-2 block text-sm font-medium text-[#DCE7F2]">Dog Experience</span>
                            <select value={experience} onChange={(e) => setExperience(e.target.value)} name="Experience" className="w-full rounded-2xl border border-[#2E5B86]/70 bg-white/[0.03] px-4 py-3 text-white">
                              <option value="">Select</option>
                      ...
                      <label className="block">
                        <span className="mb-2 block text-sm font-medium text-[#DCE7F2]">Subject</span>
                        <input type="text" name="Subject" placeholder="Optional details" className="w-full rounded-2xl border border-[#2E5B86]/70 bg-white/[0.03] px-4 py-3 text-white outline-none transition focus:border-[#D4AF37]/40 focus:bg-white/[0.05]" />
                      </label>

                      <label className="block">
                        <span className="mb-2 block text-sm font-medium text-[#DCE7F2]">Message</span>
                        <textarea rows={6} name="Message" placeholder="Write your message here..." required className="w-full rounded-2xl border border-[#2E5B86]/70 bg-white/[0.03] px-4 py-3 text-white outline-none transition focus:border-[#D4AF37]/40 focus:bg-white/[0.05]" />
                      </label>

                      <div className="flex items-center justify-between gap-4 pt-2">
                        <div>
                          <p className="text-sm leading-7 text-[#8FA6BE]">We typically respond within 24–48 hours.</p>
                          {contactStatus === "error" && <p className="text-sm font-medium text-red-300">Something went wrong while sending. Please try again.</p>}
                        </div>
                        <button type="submit" disabled={contactStatus === "sending"} className="rounded-2xl bg-[#D4AF37] px-6 py-3 font-bold text-[#102944] transition duration-200 hover:-translate-y-0.5 hover:bg-[#E0C15A] disabled:cursor-not-allowed disabled:opacity-70">
          ...
          <>
            <section className="px-6 pb-18 pt-16 lg:px-8 lg:pb-24 lg:pt-20">
            ...
            <section id="about" className="px-6 py-22 lg:px-8">
              <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
                <div className="rounded-[2.25rem] border border-[#2E5B86]/80 bg-[linear-gradient(180deg,rgba(24,58,91,0.90)_0%,rgba(16,41,68,0.96)_100%)] p-8 shadow-[0_24px_50px_rgba(0,0,0,0.18)] lg:p-10">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {[
                    ...
                    <div key={title} className="rounded-[1.6rem] border border-[#2E5B86]/80 bg-[linear-gradient(180deg,rgba(18,46,74,0.96)_0%,rgba(14,35,56,0.98)_100%)] p-6 shadow-[0_16px_34px_rgba(0,0,0,0.14)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,0,0,0.18)]">
                      <h3 className="text-lg font-bold text-white">{title}</h3>
                      <p className="mt-3 text-sm leading-7 text-[#B8C9DB]">{text}</p>
                    </div>
                  ))}
            ...
            <section id="dogs" className="px-6 py-8 lg:px-8">
              <div className="mx-auto max-w-5xl rounded-[2.25rem] border border-[#2E5B86]/80 bg-[linear-gradient(180deg,rgba(24,58,91,0.90)_0%,rgba(16,41,68,0.94)_100%)] p-10 text-center shadow-[0_22px_46px_rgba(0,0,0,0.16)]">
            ...
            <section id="philosophy" className="px-6 py-22 lg:px-8">
              <div className="mx-auto max-w-5xl">
                <div className="text-center">
