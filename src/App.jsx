    ...
    const observer = new IntersectionObserver(
      (entries) => {
        entries.forEach((entry) => {
          if (page === "home" && entry.isIntersecting) {
            ...
            <div className="mx-auto max-w-7xl">
              ...
              <div className="mt-14 grid gap-6 md:grid-cols-3">
                {founderCards.map((person) => (
                  <div
                    key={person.name}
                    className={`rounded-[1.9rem] border border-[#2E5B86]/80 ${CardGradient} p-8 shadow-[0_24px_48px_rgba(0,0,0,0.18)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_28px_56px_rgba(0,0,0,0.22)]`}
                  >
            ...
            <div className="mx-auto max-w-5xl">
              <div className="text-center">
                ...
                <p className="mt-5 text-lg leading-8 text-[#DCE7F2]">
                  ...
                  partnerships, or support. We respond with clarity and purpose.
                </p>
              </div>

              <div className="mt-14 grid items-start gap-6 lg:grid-cols-[1.05fr_0.95fr]">
                <div
                  className={`self-start rounded-[2rem] border border-[#2E5B86]/80 ${CardGradient} p-8 shadow-[0_24px_48px_rgba(0,0,0,0.18)]`}
                >
          ...
          <>
                ...
                <div>
                  ...
                  <div className="mt-8 flex flex-wrap gap-4">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="rounded-2xl border border-[#3B6C99] px-6 py-3 font-medium text-white transition duration-200 hover:-translate-y-0.5 hover:bg-white/5 hover:text-[#E0C15A]"
                    >
                      Adoption Application
                    </a>
                    <a
                    ...
                    <div className="rounded-[1.75rem] border border-[#D4AF37]/18 bg-[linear-gradient(180deg,rgba(18,46,74,0.98)_0%,rgba(14,35,56,0.98)_100%)] p-6">
                      ...
                      <div className="mt-8 grid gap-4">
                        {[
                          ...
                          <div
                            key={title}
                            className="rounded-2xl border border-[#2E5B86]/70 bg-white/[0.03] p-5 transition duration-200 hover:bg-white/[0.045]"
                          >
                            <p className="text-sm font-bold text-white">
                              {title}
                            </p>
            ...
            <section id="about" className="px-6 py-24 lg:px-8">
              <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
                <div
                  className={`rounded-[2.25rem] border border-[#2E5B86]/80 ${CardGradient} p-8 shadow-[0_24px_50px_rgba(0,0,0,0.18)] lg:p-10`}
                >
                  <p className="text-xs font-semibold uppercase tracking-[0.32em] text-[#E0C15A]">
                    About Pack Life Dog Rescue And Rehabilitation
                  </p>
                  <h2 className="mt-4 text-3xl font-black text-white sm:text-4xl lg:text-[2.9rem]">
                    This is not a flip and place rescue model.
                  </h2>
                  <p className="mt-5 max-w-2xl text-lg leading-8 text-[#DCE7F2]">
                    Pack Life Dog Rescue And Rehabilitation is built around
                    decompression, observation, structure, and honest
                    rehabilitation. Many dogs enter rescue overstimulated,
                    misunderstood, or never given a fair chance. We slow the
                    process down so stability comes first and placement actually
                    lasts.
                  </p>
                </div>
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  {[
                    ...
                    <div
                      key={title}
                      className={`rounded-[1.6rem] border border-[#2E5B86]/80 ${DarkGradient} p-6 shadow-[0_16px_34px_rgba(0,0,0,0.14)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_20px_40px_rgba(0,0,0,0.18)]`}
                    >
            ...
            <section id="dogs" className="px-6 py-8 lg:px-8">
              <div
                className={`mx-auto max-w-5xl rounded-[2.25rem] border border-[#2E5B86]/80 ${CardGradient} p-10 text-center shadow-[0_22px_46px_rgba(0,0,0,0.16)]`}
              >
                <p className="text-xs font-semibold uppercase tracking-[0.32em] text-[#E0C15A]">
                  Available Dogs
                </p>
                ...
                <p className="mt-4 mx-auto max-w-2xl text-lg leading-8 text-[#B8C9DB]">
                  We are currently preparing and evaluating dogs for placement.
                  Submit an application now to be considered when the right dog
                  becomes available.
                </p>
                <div className="mt-6 flex justify-center gap-4">
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="rounded-2xl bg-[#D4AF37] px-5 py-3 font-bold text-[#102944] transition duration-200 hover:-translate-y-0.5 hover:bg-[#E0C15A]"
                  >
                    Adoption Application
                  </a>
                </div>
